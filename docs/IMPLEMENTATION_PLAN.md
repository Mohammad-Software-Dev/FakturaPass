...
10. **FP-004 and operational readiness:** local snapshot creation and isolated restore verification implemented; see RECOVERY.md. replace local identities with the selected production OIDC provider and complete production membership/scoped-key behavior, then verify hosting, backups and recovery. Provider and deployment decisions remain in TBD.md.
