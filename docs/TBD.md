...
| 006 | First customer export mapping          | Customer/product   | Pilot              | JSON/CSV; synthetic recipe                      |
| 007 | Verified recipient requirements        | Domain/customer    | Pilot              | Versioned tenant reviews; real evidence pending |
